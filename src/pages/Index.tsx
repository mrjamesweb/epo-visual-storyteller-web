      ...
      <section className="relative bg-gradient-to-br from-primary via-secondary to-accent min-h-[80vh] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <div className="animate-fade-in">
            ...
            <p className="text-xl sm:text-2xl mb-8 text-accent max-w-3xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {recentProjects.map((project, index) => (
              <div key={index} className="bg-secondary p-6 rounded-lg hover:bg-secondary/90 transition-colors duration-300">
                <h3 className="text-lg font-semibold text-gold mb-2">Featured Project</h3>
